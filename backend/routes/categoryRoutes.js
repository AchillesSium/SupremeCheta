...
// Category Routes
router.post('/', upload.single('image'), categoryController.createCategory); // Create a new category
...
router.put('/:id', upload.single('image'), categoryController.updateCategory); // Update a category
